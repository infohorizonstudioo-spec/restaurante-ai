...
const PLANS = [
  {
    ...
    tagline: 'Lo esencial para automatizar tu negocio',
    features: [
      '50 llamadas/mes incluidas',
      '0.90€ por llamada extra',
  ...
  },
  {
    ...
    tagline: 'Inteligencia y canales para crecer',
    features: [
      '200 llamadas/mes incluidas',
      '0.70€ por llamada extra',
      'Todo lo de Starter +',
      'Pedidos y encargos por teléfono',
      'Entregas a domicilio con dirección',
      'Estadísticas avanzadas (conversión, hora pico)',
      'TPV inteligente por hora del día',
      'Sugerencias diarias de la IA',
      'Aprendizaje automático de patrones',
      'Push notifications',
      'Canal WhatsApp automático',
      'Gestión de productos y carta',
      'CRM avanzado (scoring, VIP, at-risk)',
  ...
  },
  {
    ...
    tagline: 'Todo sin límites para alta demanda',
    features: [
      '600 llamadas/mes incluidas',
      '0.50€ por llamada extra',
      'Todo lo de Pro +',
      'Canal Email automático',
      'Stock inteligente y proveedores',
      'Auto-pedidos a proveedores (semanal)',
