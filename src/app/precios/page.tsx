...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      'Todo lo de Starter +',
      'Pedidos y encargos por teléfono en vivo',
      'Entregas a domicilio con dirección',
      'Alertas instantáneas de nuevos encargos',
      'Estadísticas avanzadas de rendimiento',
      'Análisis de conversión y hora pico',
      'Insights inteligentes — tu IA aprende sola',
      'Aprendizaje automático de patrones del negocio',
      'Catálogo de servicios consultable por voz',
      'Soporte prioritario',
    ],
  },
  {
