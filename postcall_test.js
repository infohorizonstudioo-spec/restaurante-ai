...
Cliente: Perfecto, gracias.`;
  ...
  check(uniqIntents.size >= 2, '>=2 intents distintos detectados (reserva/pedido/cancelacion/consulta): '+[...uniqIntents].join(','));
  ...
  check(delta >= 11, 'Contador subió >= 11 (tenemos 11+ llamadas con transcript en tests): Δ='+delta);
  check(metricsAfter.calls_completed >= metricsBefore.calls_completed + 11, 'Completadas subieron: '+metricsAfter.calls_completed);
